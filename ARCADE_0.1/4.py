...
win_sound = mixer.Sound('victory.mp3')
...
img_hero = "fighter-jet.png"  # герой
...
# створюємо спрайти
ship = Player(img_hero, 5, win_height - 150, 120, 120, 15)
 
monsters = sprite.Group()
for i in range(1, 6):
    monster = Enemy(img_enemy, randint(
        80, win_width - 80), -40, 120, 100, randint(1, 5))
